...
static const struct ipahal_reg_obj ipahal_regs[] = {
	...
	reg_obj_nofunc(IPA_DPS_SEQUENCER_FIRST,		0x0001e000,	0x0000),
	reg_obj_nofunc(IPA_HPS_SEQUENCER_FIRST,		0x0001e080,	0x0000),
	reg_obj_nofunc(IPA_ENABLE_GSI,			0x00002790,	0x0000),
