...
int ipa_init_mem_info(struct device_node *node)
{
	...
	mem_info[APPS_V4_RT_HASH_OFST] = IPA_MEM_APPS_V4_RT_HASH_OFST;
	mem_info[APPS_V4_RT_HASH_SIZE] = IPA_MEM_APPS_V4_RT_HASH_SIZE;
	ipa_debug("V4 APPS HASHABLE RT OFST 0x%x SIZE 0x%x\n",
			mem_info[APPS_V4_RT_HASH_OFST],
			mem_info[APPS_V4_RT_HASH_SIZE]);

	mem_info[APPS_V4_RT_NHASH_OFST] = IPA_MEM_APPS_V4_RT_NHASH_OFST;
	mem_info[APPS_V4_RT_NHASH_SIZE] = IPA_MEM_APPS_V4_RT_NHASH_SIZE;
	ipa_debug("V4 APPS NON-HASHABLE RT OFST 0x%x SIZE 0x%x\n",
			mem_info[APPS_V4_RT_NHASH_OFST],
			mem_info[APPS_V4_RT_NHASH_SIZE]);

	mem_info[APPS_V6_RT_HASH_OFST] = IPA_MEM_APPS_V6_RT_HASH_OFST;
	mem_info[APPS_V6_RT_HASH_SIZE] = IPA_MEM_APPS_V6_RT_HASH_SIZE;
	ipa_debug("V6 APPS HASHABLE RT OFST 0x%x SIZE 0x%x\n",
			mem_info[APPS_V6_RT_HASH_OFST],
			mem_info[APPS_V6_RT_HASH_SIZE]);

	mem_info[APPS_V6_RT_NHASH_OFST] = IPA_MEM_APPS_V6_RT_NHASH_OFST;
	mem_info[APPS_V6_RT_NHASH_SIZE] = IPA_MEM_APPS_V6_RT_NHASH_SIZE;
	ipa_debug("V6 APPS NON-HASHABLE RT OFST 0x%x SIZE 0x%x\n",
			mem_info[APPS_V6_RT_NHASH_OFST],
			mem_info[APPS_V6_RT_NHASH_SIZE]);
	...
	mem_info[STATS_QUOTA_OFST] = IPA_MEM_STATS_QUOTA_OFST;
	mem_info[STATS_QUOTA_SIZE] = IPA_MEM_STATS_QUOTA_SIZE;
	mem_info[STATS_TETHERING_OFST] = IPA_MEM_STATS_TETHERING_OFST;
	mem_info[STATS_TETHERING_SIZE] = IPA_MEM_STATS_TETHERING_SIZE;
	mem_info[STATS_FLT_V4_OFST] = IPA_MEM_STATS_FLT_V4_OFST;
	mem_info[STATS_FLT_V4_SIZE] = IPA_MEM_STATS_FLT_V4_SIZE;
	mem_info[STATS_FLT_V6_OFST] = IPA_MEM_STATS_DROP_SIZE;
	mem_info[STATS_FLT_V6_SIZE] = IPA_MEM_STATS_FLT_V6_OFST;
	mem_info[STATS_RT_V4_OFST] = IPA_MEM_STATS_FLT_V6_SIZE;
	mem_info[STATS_RT_V4_SIZE] = IPA_MEM_STATS_RT_V4_OFST;
	mem_info[STATS_RT_V6_OFST] = IPA_MEM_STATS_RT_V4_SIZE;
