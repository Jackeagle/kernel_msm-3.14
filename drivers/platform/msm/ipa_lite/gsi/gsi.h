...
enum gsi_status {
	...
	GSI_STATUS_RING_INSUFFICIENT_SPACE = 1,
	GSI_STATUS_RES_ALLOC_FAILURE = 2,
	GSI_STATUS_BAD_STATE = 3,
	GSI_STATUS_INVALID_PARAMS = 4,
	GSI_STATUS_UNSUPPORTED_OP = 5,
	GSI_STATUS_POLL_EMPTY = 6,
};
