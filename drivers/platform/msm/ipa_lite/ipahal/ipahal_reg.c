	...
	const void *fields)
{
	...
	val |= IPA_SETFIELD(max_reads->qmb_1_max_read_beats,
			IPA_QSB_MAX_READS_BEATS_GEN_QMB_1_MAX_READS_BEATS_SHFT_V4_0,
			IPA_QSB_MAX_READS_BEATS_GEN_QMB_1_MAX_READS_BEATS_BMSK_V4_0);
	...
	const void *fields)
{
	...
	val = IPA_SETFIELD(hps_weights->hps_queue_weight_0,
		IPA_HPS_FTCH_ARB_QUEUE_WEIGHT_RX_HPS_QUEUE_WEIGHT_0_SHFT,
		IPA_HPS_FTCH_ARB_QUEUE_WEIGHT_RX_HPS_QUEUE_WEIGHT_0_BMSK);

	val |= IPA_SETFIELD(hps_weights->hps_queue_weight_1,
		IPA_HPS_FTCH_ARB_QUEUE_WEIGHT_RX_HPS_QUEUE_WEIGHT_1_SHFT,
		IPA_HPS_FTCH_ARB_QUEUE_WEIGHT_RX_HPS_QUEUE_WEIGHT_1_BMSK);

	val |= IPA_SETFIELD(hps_weights->hps_queue_weight_2,
		IPA_HPS_FTCH_ARB_QUEUE_WEIGHT_RX_HPS_QUEUE_WEIGHT_2_SHFT,
		IPA_HPS_FTCH_ARB_QUEUE_WEIGHT_RX_HPS_QUEUE_WEIGHT_2_BMSK);

	val |= IPA_SETFIELD(hps_weights->hps_queue_weight_3,
		IPA_HPS_FTCH_ARB_QUEUE_WEIGHT_RX_HPS_QUEUE_WEIGHT_3_SHFT,
		IPA_HPS_FTCH_ARB_QUEUE_WEIGHT_RX_HPS_QUEUE_WEIGHT_3_BMSK);
	...
	struct ipahal_reg_valmask *valmask)
{
	...
	if (ipahal_ctx->hw_type <= IPA_HW_v3_1) {
		shft = IPA_AGGR_FORCE_CLOSE_PIPE_BITMAP_SHFT;
		bmsk = IPA_AGGR_FORCE_CLOSE_PIPE_BITMAP_BMSK;
	} else if (ipahal_ctx->hw_type <= IPA_HW_v3_5_1) {
		shft = IPA_AGGR_FORCE_CLOSE_PIPE_BITMAP_SHFT_V3_5;
		bmsk = IPA_AGGR_FORCE_CLOSE_PIPE_BITMAP_BMSK_V3_5;
	} else {
		shft = IPA_AGGR_FORCE_CLOSE_PIPE_BITMAP_SHFT_V4_0;
		bmsk = IPA_AGGR_FORCE_CLOSE_PIPE_BITMAP_BMSK_V4_0;
	}
